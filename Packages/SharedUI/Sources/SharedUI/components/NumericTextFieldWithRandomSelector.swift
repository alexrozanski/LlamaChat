...
public struct NumericTextFieldWithRandomSelector: NSViewRepresentable {
  public enum Value {
    case random
  ...
  public init(value: Binding<Value>, formatter: NumberFormatter) {
    self.value = value
    self.formatter = formatter
  }

  public func makeNSView(context: Context) -> TextFieldWithToggleButton {
  ...
  public func updateNSView(_ nsView: TextFieldWithToggleButton, context: Context) {
  ...
  public  class Coordinator: NSObject, TextFieldWithToggleButtonDelegate {
    ...
    public func textFieldWithToggleButton(_ textFieldWithToggleButton: TextFieldWithToggleButton, didUpdateValue value: NumericTextFieldWithRandomSelector.Value) {
...
public class TextFieldWithToggleButton: NSView, NSTextFieldDelegate, ClickThroughDisabledTextFieldDelegate {
