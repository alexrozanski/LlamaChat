...
public protocol RestorableData<DomainKey> {
...
// Allows us to use in view models rather than @SceneStorage in the view.
public class StateRestoration: ObservableObject {
  public func restorableData<DomainKey>(for domain: String) -> any RestorableData<DomainKey> where DomainKey: RawRepresentable, DomainKey.RawValue == String {
