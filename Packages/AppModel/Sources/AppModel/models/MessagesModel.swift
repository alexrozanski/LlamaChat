...
public class MessagesModel: ObservableObject {
  ...
  public func loadMessages(from chatSource: ChatSource) -> [Message] {
    do {
  ...
  public func append(message: Message, in chatSource: ChatSource) {
    do {
      guard
        let db,
  ...
  public func clearMessages(for chatSource: ChatSource) {
    do {
